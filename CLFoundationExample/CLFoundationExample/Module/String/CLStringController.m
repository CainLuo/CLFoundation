...
#pragma mark - 账号相关
    ...
    [self.cl_textViewString appendFormat:@"检测\"%@\"是否是字母开头至少6位至多18位的密码(可含有\"_\"): %@\n", cl_passwordString, [cl_passwordString cl_checkPassword] ? @"YES" : @"NO"];
    [self.cl_textViewString appendFormat:@"检测\"%@\"是否包含大小写字母至少6位至多12位的强密码: %@\n", cl_strongPassword, [cl_strongPassword cl_checkStrongPassword:6
                                                                                                                                                    longest:12] ? @"YES" : @"NO"];
